<?php /* Smarty version 2.6.11, created on 2017-04-24 13:20:28
                            ...
                            <td scope="row">
                                ...
                                <table cellpadding=0 cellspacing=0><input id='whatnext' name='whatnext' type="hidden" value='finish' />
                                    <?php if ($this->_tpl_vars['IS_ADMIN']): ?>
                                        ...
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/university.png style="margin-right: 5px;"></td><td><a href="http://www.suitecrm.com/forum/index" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH11']; ?>
 </b></a></b><br><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH12']; ?>
</td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                    <?php else: ?>
                                        <tr><td><img src=include/images/university2.png style="margin-right: 5px;"></td><td><a href="http://www.suitecrm.com/forum/index" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH11']; ?>
 </b></a></b><br><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH12']; ?>
</td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        ...
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.suitecrm.com/forum/index" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH18']; ?>
